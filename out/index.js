...
const parserOptions$1 = {
  ecmaVersion: 6,
  sourceType: 'module'
};
const plugins$1 = ['import'];
const settings$1 = {
  'import/resolver': {
    node: {
      extensions: ['.js', '.json']
...
var mocha = /*#__PURE__*/Object.freeze({
  env: env$5,
  globals: globals$1,
  rules: rules$9
});

var base = __chunk_1.mergeConfigs([bestPractices, docs, errors, node, style, variables, imports, es6, // Special environments
browser, mocha]);
